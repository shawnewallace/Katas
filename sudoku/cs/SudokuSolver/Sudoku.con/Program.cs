...
namespace Sudoku.con
{
	class Program
	{
		static void Main(string[] args)
		{
			...
			//for (var i = 0; i < 300; i++)
			//{
			//	solution = SudokuSolverCs.search(SudokuSolverCs.parse_grid(hardest));
			//}
			...
			solver.print_board(solver.parse_grid(hardest));

			Console.WriteLine("*****");

			solver.print_board(solver.search(solver.parse_grid(hardest)));
...
//				SudokuSolverCs.print_board(SudokuSolverCs.search(SudokuSolverCs.parse_grid(game)));
//				SudokuSolverCs.search(SudokuSolverCs.parse_grid(game));
//			}
